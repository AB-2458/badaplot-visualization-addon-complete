            ...
            <div className="sticky top-0 bg-background/95 backdrop-blur border-b border-border p-4 z-10">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary/90 rounded-lg text-sm text-primary-foreground font-medium transition-colors"
                    >
                    ...
                    filteredPlots.map((plot) => {
                        ...
                        return (
                            <div
                                ...
                                className="bg-card border border-border rounded-xl p-4 cursor-pointer hover:ring-2 hover:ring-primary transition-all hover:scale-[1.02] group"
                            >
                                {/* Header */}
                                ...
                                {/* Price */}
                                <p className="text-lg font-bold text-emerald mb-3">
                                ...
                                <div className="space-y-1 text-xs text-muted-foreground">
                                    <p className="flex justify-between">
                                        <span>Type:</span>
                                        <span className="text-foreground/80">{plot.type}</span>
                                    </p>
                                    <p className="flex justify-between">
                                        <span>Area:</span>
                                        <span className="text-foreground/80">{area.toLocaleString()} Sq.ft</span>
                                    </p>
                                    <p className="flex justify-between">
                                        <span>Facing:</span>
                                        <span className="text-foreground/80">{plot.facing}</span>
                                    </p>
                                </div>
